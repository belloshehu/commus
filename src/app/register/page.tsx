    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card variant="highlight">
          <CardHeader>
            <CardTitle>Join Your Local Community Zone</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div className="p-3 bg-slate-950 border border-slate-800 rounded-lg text-[11px] text-slate-400">
                🔒 <strong>Privacy Guarantee</strong>: Your identity is never shown on public incident reports. All public submissions display <em>&quot;Reported by a verified community member&quot;</em>.
              </div>
